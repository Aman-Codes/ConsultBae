        ...
        <div className="row m-5">
            <div className="col-md-4 p-3">
                <div className="service-card">
                    <img src={recruitment} alt="recruitment svg" className="card-svg-image m-3" />
                    <h3>Recruitment</h3>
            ...
            <div className="col-md-4 p-3">
                <div className="service-card">
                    <img src={championCV} alt="championCV svg" className="card-svg-image m-3" />
                    <h3>Chanpion CV</h3>
                    <p className="text-grey">
                        End to End recruitment solution to complement the growth of organisation
                    </p>
            ...
            <div className="col-md-4 p-3">
                <div className="service-card">
                    <img src={careerCounsel} alt="careerCounsel svg" className="card-svg-image m-3" />
